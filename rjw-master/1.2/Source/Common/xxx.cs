	...
	public static class xxx
	{
		...
		public static void TransferNutrition(Pawn pawn, Pawn partner, rjwSextype sextype)
		{
			...
			if (Genital_Helper.has_penis_fertile(pawn) && (
				...
				sextype == xxx.rjwSextype.Cunnilingus ||
			...
			if (sextype == xxx.rjwSextype.Oral ||
				sextype == xxx.rjwSextype.Cunnilingus ||
				sextype == xxx.rjwSextype.Fellatio ||
		...
		public static void think_about_sex(Pawn pawn, Pawn partner, bool isReceiving, bool violent = false, rjwSextype sextype = rjwSextype.None, bool isCoreLovin = false, bool whoring = false)
		{
			...
			if (partner == null)
			{
				ModLog.Error("xxx::think-after_sex( ERROR: " + get_pawnname(pawn) + " has no partner. This should not be called from solo acts. Sextype: " + sextype);
				return;
			}
