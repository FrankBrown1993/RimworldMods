...
namespace rjw
{
	public class CompRJW : ThingComp
	{
		...
		public static bool CheckPreference(Pawn pawn, Pawn partner)
		{
			...
			var partnerparts = partner.GetGenitalsList();
			...
			//genitals missing, use gender instead
			if (pawnparts.NullOrEmpty() || partnerparts.NullOrEmpty())
			{
				isHetero = pawn.gender != partner.gender;
				isHomo = pawn.gender == partner.gender;
			}
