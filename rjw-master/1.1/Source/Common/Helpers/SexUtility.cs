...
namespace rjw
{
	public class SexUtility
	{
			...
			if (pawn != null && partner != null)
			{
				...
				if (!partner.Dead)
				{
					...
					if (rape)
					{
						...
						// Handled in satisfaction stat now
		...
		private static void SatisfyPersonal(Pawn pawn, Pawn partner, xxx.rjwSextype sextype, bool violent, bool pawn_is_raping, float satisfaction)
		{
