...
namespace rjw
{
	...
	public static class PregnancyHelper
	{
		...
		public static void impregnate(Pawn pawn, Pawn partner, xxx.rjwSextype sextype = xxx.rjwSextype.None)
		{
			...
			if ((Genital_Helper.has_vagina(partner, partnerparts) || (Genital_Helper.has_anus(partner) && sextype == xxx.rjwSextype.Anal)) &&
				...
				)
				{
					...
					if (!(sextype == xxx.rjwSextype.Anal) || (partner.health.hediffSet.HasHediff(HediffDef.Named("RJW_Cocoon")) && sextype == xxx.rjwSextype.Anal))
		...
		public static void Doimpregnate(Pawn pawn, Pawn partner)
		{
			...
			{
				if (RJWSettings.DevMode) ModLog.Message(" Impregnation failed. Chance: " + pregnancy_chance.ToStringPercent() + " roll_to_fail: " + pregnancy_roll_to_fail.ToStringPercent());
				return;
			}
			if (RJWSettings.DevMode) ModLog.Message(" Impregnation succeeded. Chance: " + pregnancy_chance.ToStringPercent() + " roll_to_fail: " + pregnancy_roll_to_fail.ToStringPercent());
