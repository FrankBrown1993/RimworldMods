...
namespace rjw
{
	...
	{
		// TODO: Clean these.
		// Commented out old configs that are no longer in use (or have been converted into settings).
		...
		//public float fertility_endAge_female_humanlike;
		//public float fertility_endAge_female_animal;
	}
}